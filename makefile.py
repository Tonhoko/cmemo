...
DIST_FILES = {
    ...
    "license" :             "cmemo/license",
    "doc/html" :            "cmemo/doc",
    "library.zip" :         "cmemo/library.zip",
    "dict/.keepme" :        "cmemo/dict/.keepme",
    "extension/.keepme" :   "cmemo/extension/.keepme",
    }
...
def target_copy():
    ...
    shutil.copy( "cmemo_native.pyd", "lib/cmemo_native.pyd" )
